...
function Contact() {
  ...
  return (
    <div
      name="Contact"
      className="max-w-screen-xl mx-auto px-6 md:px-16 my-16 bg-gray-50 rounded-xl shadow-lg py-12"
    >
      <Toaster />
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-10">
        ...
        <div className="bg-white shadow-xl rounded-xl p-6 flex flex-col items-center space-y-8">
          <div className="flex flex-col items-center">
            <h2 className="text-4xl sm:text-5xl font-extrabold text-purple-600 tracking-wide select-none">
              Manjeet <span className="text-gray-800">Verma</span>
            </h2>
            <p className="text-gray-600 italic mt-1 text-center">
              Global Tender & Bid Manager | Government Procurement Expert
            </p>
          ...
          <div className="space-y-6 w-full text-gray-700">
            <div className="flex items-center gap-4">
              ...
              <span>manjeetmau1994@gmail.com</span>
            </div>
            <div className="flex items-center gap-4">
              <FaPhoneAlt className="text-purple-600 text-xl" />
              <span>+91 7080886174</span>
            </div>
            <div className="flex items-center gap-4">
        ...
        >
          ...
          <div>
            ...
            <textarea
              ...
              className="w-full border rounded-lg px-3 py-2 bg-gray-50 focus:ring-2 focus:ring-purple-400 resize-none"
              rows="4"
